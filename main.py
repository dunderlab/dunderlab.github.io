...
class StaticApp(RadiantInterfaceApp):
    ...
    def on_scroll(self, event):
        ...
        document.select_one("#dunderlab--container-home").style.backgroundPositionY = (
            str(scrollTop * 0.5) + "px"
        )
    ...
    def build_menubar(self):
        ...
        self.menubar <= html.DIV(
            ...
            style={"background-image": "url(/root/assets/icons/tally-4.svg)"},
        )

        with html.DIV(
            Class="dunderlab-float-menu",
            style={
                "display": "none",
            },
        ).context(self.body) as parent:
            with html.UL(Class="dunderlab-menu").context as menubar_parent:
                for element in menu:
                    element_id = element.lower().replace(" ", "_").replace("&", "and")
                    li = html.LI(Class="dunderlab-menu--item", id=f"{element_id}--menu")
        ...
        select(".dunderlab-float-menu--launcher").bind(
            "click", self.toggle(".dunderlab-float-menu")
        )
        select(".dunderlab-menu--item").bind(
            "click", self.hide(".dunderlab-float-menu")
        )
    ...
    def cambiar_estilo(self, evt):
        ...
        if window.scrollY < 600:
            ...
            document.select_one(".dunderlab--home").style = {
                "background-size": f"{self.map_value(window.scrollY, 0, 600, 215, 140)}px",
            }
        else:
            # self.menubar.style = {'background-color': f'rgba(26, 83, 92, 0.2)', }
            document.select_one(".dunderlab--home").style = {
                "background-size": f"140px",
            }
    ...
    def smooth_scroll(self, evt):
        ...
        window.scroll(
            {"top": target_element.offsetTop - 90, "left": 0, "behavior": "smooth"}
        )
    ...
    def adjust_scroll(self, event):
        ...
        for section in sections:
            ...
            if scrolling_down and distance > 0 and distance < minimum_distance:
                ...
                select(".dunderlab-menu--item").classes.remove("selected")
                select(
                    f'#{section.id.replace("dunderlab--container-",  "")}--menu'
                ).classes.append("selected")

            elif (
                not scrolling_down and distance < 0 and abs(distance) < minimum_distance
            ):
        ...
        if closest_section and minimum_distance < 700:
            window.scrollTo(
                {"top": closest_section.offsetTop - 90, "behavior": "smooth"}
            )
    ...
    def build_portrait(self):
        """"""
        with html.DIV(
            Class="dunderlab--container container-fluid", id="dunderlab--container-home"
    ...
    def build_capabilities(self):
        ...
        with html.DIV(
            Class="dunderlab--container container",
            id="dunderlab--container-competencies",
        ).context as container:
            with html.DIV(Class="row").context as row:
                ...
                with html.DIV(Class=cards_style).context:
                    with html.DIV(Class="dunderlab-capability").context as col:
                        col <= html.DIV(
                            style={
                                "background-image": "url(/root/assets/icons/laptop-code.svg)"
                            },
                ...
                with html.DIV(Class=cards_style).context:
                    with html.DIV(Class="dunderlab-capability").context as col:
                        col <= html.DIV(
                            style={
                                "background-image": "url(/root/assets/icons/lightbulb-setting.svg)"
                            },
                            Class="dunderlab-capability--image",
                        )
                ...
                with html.DIV(Class=cards_style).context:
                    with html.DIV(Class="dunderlab-capability").context as col:
                        col <= html.DIV(
                            style={
                                "background-image": "url(/root/assets/icons/microchip.svg)"
                            },
                            Class="dunderlab-capability--image",
                        )
                ...
                with html.DIV(Class=cards_style).context:
                    with html.DIV(Class="dunderlab-capability").context as col:
                        col <= html.DIV(
                            style={
                                "background-image": "url(/root/assets/icons/rocket-lunch.svg)"
                            },
                            Class="dunderlab-capability--image",
                        )
                        col <= html.H1(
                ...
                with html.DIV(Class=cards_style).context:
                    with html.DIV(Class="dunderlab-capability").context as col:
                        col <= html.DIV(
                            style={
                                "background-image": "url(/root/assets/icons/cloud-code.svg)"
                            },
                            Class="dunderlab-capability--image",
                        )
                ...
                with html.DIV(Class=cards_style).context:
                    with html.DIV(Class="dunderlab-capability").context as col:
                        col <= html.DIV(
                            style={
                                "background-image": "url(/root/assets/icons/brain-circuit.svg)"
                            },
                            Class="dunderlab-capability--image",
                        )
    ...
    def build_mission_and_vision(self):
        ...
        with html.DIV(
            Class="dunderlab--container container",
            id="dunderlab--container-mission_and_vision",
        ).context as container:
            with html.DIV(Class="row").context as row:
        ...
        with html.DIV(
            ...
            with html.DIV(Class="row").context as row:
                ...
                for i, project in enumerate(
                    sorted(projects, key=lambda x: x["year"], reverse=True)
                ):
                    ...
                    with html.DIV(
                        Class=f"col-12 col-md-6 dunderlab-dev {frame_style}"
                    ).context as col:
                        with html.DIV(Class="row").context as row:

                            with html.DIV(
                                Class=f"dunderlab-dev--logo dunderlab-dev--logo-pre {logo_style} col-auto"
                            ).context as col_logo:
                        ...
                        with html.DIV(Class=f"dunderlab-line {style}").context(
                            ...
                            if project.get("documentation"):
                                line <= icons.fa(
                                    "book",
                                    Class=f"dunderlab-dev--fa-icon dunderlab-dev--logo-pre {logo_style}",
                                )
                                line <= html.A(
                                ...
                                line <= icons.fa(
                                    "book",
                                    Class=f"dunderlab-dev--fa-icon dunderlab-dev--logo-post {logo_style}",
                                )
                        ...
                        with html.DIV(Class=f"dunderlab-line {style}").context(
                            ...
                            if project.get("page"):
                                ...
                                line <= html.A(
                                    project["page"], href=project["page"], Class=style
                                )
                                line <= icons.fa(
                                    "link",
                                    Class=f"dunderlab-dev--fa-icon dunderlab-dev--logo-post {logo_style}",
                        ...
                        col <= html.DIV(
                            ", ".join(project["tools"]),
                            Class=f"dunderlab-dev--tools {style_tools}",
                        )
        ...
        with html.DIV(
            ...
            with html.DIV(Class="row", style={"margin-top": "100px"}).context as row:
                ...
                with html.DIV(Class="col dunderlab-client").context as col:
                    col.style["background-image"] = (
                        "url(/root/assets/clients/Logotipo_de_la_Universidad_Nacional_de_Colombia.svg)"
                    )

                with html.DIV(Class="col dunderlab-client").context as col:
                    col.style["background-image"] = (
                        "url(/root/assets/clients/utp_universidad_tecnologica_de_pereira.svg)"
                    )

                with html.DIV(Class="col dunderlab-client").context as col:
                    col.style["background-image"] = (
                        "url(/root/assets/clients/Logo_de_la_Universidad_de_Caldas.svg)"
                    )
    ...
    def build_footer(self):
        """"""
        with html.DIV(
            Class="dunderlab--container container-fluid",
            id="dunderlab--container-footer",
        ).context as container:
            with html.DIV(Class="row").context as row:
                with html.DIV(
                    Class="col",
